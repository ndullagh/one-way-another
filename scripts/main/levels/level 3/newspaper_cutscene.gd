...
func _process(delta: float) -> void:
	...
	if player_inside and Input.is_action_just_pressed("Enter") and not cutscene_triggered:
		...
		textbox.queue_text("Kol: This must've been from back when the war started...", "res://cutscenes/newspaper.png") #holding newspaper
		textbox.queue_text("Kol: Earth-Shattering Technological Advancements Will Turn The Tide'? - Well, it sure shattered something alright. It feels like reality itself is falling apart.")
		textbox.queue_text("Kol: Half of these articles are just talking about increasing stocks and profit margins.")
		textbox.queue_text("Kol: What kind of war were we fighting...?")
