...
func _on_body_entered(body):
	...
	if body.is_in_group("Player"):  # THIS WILL NEED TO CHANGE IF PLAYER IS NO LONGER THE ONLY CHARACTER_BODY_2D
		...
		textbox.queue_text("Kol: Wow... I never thought I'd actually get to her. Is this where she's been staying while I've been away?",  "res://cutscenesp/c5/1.png") #-standing outside
		...
		textbox.queue_text("Kol: Ev...? Are you in here? I heard your signal...", "res://cutscenesp/c5/2.png") #establishing shot
		textbox.queue_text("Kol: ...What the...", "res://cutscenesp/c5/3.png") #sees pod
		textbox.queue_text("Kol: Is... Is that...", "res://cutscenesp/c5/4.png") #wipe
		textbox.queue_text("Kol: ...me...?") # reaction
		textbox.queue_text("[STATIC]")
		textbox.queue_text("Kol: -!", "res://cutscenesp/c5/5.png") # turns around and sees hologram
		textbox.queue_text("Evelyn: K- a l?/>; lum;.,- c an you he a r me?", "res://cutscenesp/c5/6.png") 
		textbox.queue_text("Kol: Kallum? Why do I know that name...?")
		textbox.queue_text("Kol: ...", "res://cutscenesp/c5/7.png")
		textbox.queue_text("Kol: ...!", "res://cutscenesp/c5/8.png") #sees name on pod
		textbox.queue_text("Evelyn: Kallum... if this recording is playing, it must be you.", "res://cutscenesp/c5/9.png") #ev talking
		...
		textbox.queue_text("Kol: Save... me...?", "res://cutscenesp/c5/10.png") #kol reaction?
		textbox.queue_text("Kol: N-no...")
		textbox.queue_text("Evelyn: I tried to ensure some part of you would be left behind after it was over. Even if it was a copy. A machine.", "res://cutscenesp/c5/9.png") #ev talking
		...
		textbox.queue_text("Kol: Please don't go... you're the only thing I have left-!", "res://cutscenesp/c5/11.png") #kol tearing up
		textbox.queue_text("Evelyn: I love you, Kallum. Goodbye.", "res://cutscenesp/c5/12.png") #ev fades out
		textbox.queue_text("...", "res://cutscenesp/c5/13.png") #kol falls to knees
		textbox.queue_text("Kol: HOW?! HOW C-COULD YOU-! *hic* IT'S NOT FAIR! IT'S NOT FAIR IT'S NOT FAIRIT'SNOTFAIRIT'SNOTFAIR!!!!", "res://cutscenesp/c5/14.png")
		textbox.queue_text("Kol: YOU C-CAN'T LEAVE ME HERE!! NOT AGAIN! I CAN'T BE ALL ALONE AGAIN, PLEASE-!")
		textbox.queue_text("Kol: Y-you can't... You can't. not like this.", "res://cutscenesp/c5/15.png") #quieter expression?
		textbox.queue_text("Kol: I don't deserve to go through this again.", "res://cutscenesp/c5/16.png") # just smile
		textbox.queue_text("Kol: I'm sorry, Ev. Thank you for everything.", "res://cutscenesp/c5/17.png") # grabs pipe
		textbox.queue_text("", "res://cutscenesp/c5/18.png")
		...
		textbox.queue_text("Kol: ...?", "res://cutscenesp/c5/19.png")
		textbox.queue_text("\" Whatever you do, keep helping people. That's the kind of person you've always been. If you don't, who will? - Ev\"", "res://cutscenesp/c5/20.png") # reads note
		...
		music_player_2.play()
		 # Crossfade over time
		music_tween.parallel().tween_property(music_player_1, "volume_db", -40, 3)  # Fade out
		music_tween.parallel().tween_property(music_player_2, "volume_db", 0, 3)   # Fade in
