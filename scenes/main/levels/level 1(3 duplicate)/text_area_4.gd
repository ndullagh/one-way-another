...
func _process(delta: float) -> void:
	...
	if player_inside and Input.is_action_just_pressed("Enter") and not cutscene_triggered:
		...
		textbox.queue_text("Kol: It's an old war machine - looks just like the others around here.", "res://cutscenes/robot.png")
		textbox.queue_text("It's weird how many of them are still fighting...")
		textbox.queue_text("Yeesh, if the war's still going then I'm in BIG trouble for deserting.")
		print("QUEUED ROBOT DIALOGUE")
